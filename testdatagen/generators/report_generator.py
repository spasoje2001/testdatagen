...
from testdatagen.generators.neo4j_generator import (
...
{% if relationships %}
<h2 style="margin-top:3rem;">Relationships</h2>
...
<table>
    ...
    {% for relationship in relationships %}
        <tr>
            ...
            <td>{{ relationship.strategy }}</td>
            <td>{{ relationship.generate }}</td>
            <td>{{ relationship.include_cases }}</td>
            <td>
            {% if relationship.properties %}
                <ul style="margin:0;padding-left:18px;">
                {% for p in relationship.properties %}
                    <li>
...
class ReportGenerator:
    ...
    def _build_context(self) -> Dict:
        ...
        return {
            ...
            "relationships": relationship_contexts,
        }

    def _build_relationship_context(self, relationship):
