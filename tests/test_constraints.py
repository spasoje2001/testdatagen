...
def test_boundary_constraint():
    ...
    assert _schema_entities(model)[0].fields[0].constraints[0].__class__.__name__ == "BoundaryConstraint"
...
def test_partition_constraint():
    ...
    assert _schema_entities(model)[0].fields[0].constraints[0].value == 5
...
def test_partitions_constraint():
    ...
    assert _schema_entities(model)[0].fields[0].constraints[0].values == [10, 20, 30]
...
def test_unique_constraint():
    ...
    assert _schema_entities(model)[0].fields[0].constraints[0].__class__.__name__ == "UniqueConstraint"
...
def test_precision_constraint():
    ...
    assert _schema_entities(model)[0].fields[0].constraints[0].value == 2
...
def test_special_constraint():
    ...
    assert _schema_entities(model)[0].fields[0].constraints[0].values == ["N/A", "UNKNOWN"]
...
def test_coverage_constraint():
    ...
    assert _schema_entities(model)[0].fields[0].constraints[0].value == 80
...
def test_include_constraint():
    ...
    assert _schema_entities(model)[0].fields[0].constraints[0].values == ["null", "empty", "invalid"]
...
def test_field_level_strategy_override():
    ...
    assert _schema_entities(model)[0].fields[0].constraints[0].value == "boundary"
